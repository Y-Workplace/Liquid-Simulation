...
- `OceanFoamBufferDecay` number: dissipacao por segundo aplicada aos canais de foam e agua verde. Padrao `0.72`.
...
- `OceanCrestFoamStrength` number: escala da foam de crista/whitecap. Padrao `0.72`.
- `OceanHighWaveFoamStrength` number: foam extra em ondas altas. Padrao `0.75`.
...
- `OceanFoamNoiseInfluence` number: influencia do pattern procedural apenas no fallback por cor de vertice. A textura final baked/runtime nao usa este recorte. Padrao `0.72`; `0` nao recorta, `1` usa todo o pattern.
